            ...
            <div className="card-body d-flex flex-column flex-md-row justify-content-around align-items-center p-5">
              ...
              <Form onSubmit={formik.handleSubmit} className="col-12 col-md-6 mt-3 mt-mb-0">
                ...
                <Form.Group className="mb-3 form-floating">
                  ...
                  {formik.errors.username && formik.touched.username ? (<p className="text-danger">{i18n.t('errors.usernameCountSymbols')}</p>) : null}
                </Form.Group>
                <Form.Group className="mb-3 form-floating">
                  <Form.Control
                    type="password"
                  ...
                  {formik.errors.password && formik.touched.password ? (<p className="text-danger">{i18n.t('errors.passwordCountSymbols')}</p>) : null}
                </Form.Group>
