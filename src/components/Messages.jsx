...
const MessagesForm = ({ promiseSocket }) => {
  const { currentChannelId } = useSelector((state) => state.channelsData);
  const i18n = useTranslation();
    ...
    <div className="mt-auto px-5 py-3">
      <Formik
        ...
        onSubmit={({ message }, actions) => {
          ...
          promiseSocket('newMessage', currentMessage)
          ...
          <Form onSubmit={handleSubmit} className="py-1 border rounded-2">
            <div className="input-group has-validation">
              ...
              <div className="input-group-append">
                <button disabled={!values.message} key="messageSubmit" type="submit" className="btn btn-group-vertical">
